...
<body>
    ...
    <nav class="navbar navbar-expand navbar-primary bg-primary">
        <a style="margin-left:2rem" class="  navbar-brand text-white" href="{{ route('agence.index') }}">Net'Agence</a>
        ...
        @guest
            <a class="text-white" style="margin-right: 3rem" href="{{ route('admin.login') }}">
        ...
        @auth
            <form action="{{ route('admin.logout') }}" method="POST">
                @csrf
                @method('DELETE')
                <button class="btn btn-danger" style="margin-right: 3rem">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
                        class="bi bi-house-x" viewBox="0 0 16 16">
                        <path
                            d="M7.293 1.5a1 1 0 0 1 1.414 0L11 3.793V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v3.293l2.354 2.353a.5.5 0 0 1-.708.708L8 2.207l-5 5V13.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 1 0 1h-4A1.5 1.5 0 0 1 2 13.5V8.207l-.646.647a.5.5 0 1 1-.708-.708L7.293 1.5Z" />
                        <path
